...
<template>
    ...
    <div class="flex flex-col justify-start items-center gap-2.5 px-2.5 py-2">
        ...
        <div class="grid gap-6 mb-6 md:grid-cols-2">
            <label  class="block mb-2 text-sm font-medium text-red-900 dark:text-white">結果</label>
            <div class="block mb-2 text-sm font-medium text-red-900 dark:text-white" >{{  result  }}</div>
        </div>
        <div class="grid gap-6 mb-6 md:grid-cols-2">
